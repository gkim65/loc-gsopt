...
for gs_num in 10 15 20; do
  for randseed in 0 1 2 3 4; do
    python src/main.py problem.gs_num=$gs_num debug.randseed=$randseed experiments.simplexExclude=False test_name="noExclusionSimplex"
    sleep 3
  done
done
