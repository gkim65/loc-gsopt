...
for gs_num in 1 2 3 4 5; do
  for randseed in 0 1 2 3 4; do
    python src/main.py problem.gs_num=$gs_num debug.randseed=$randseed problem.method="nelder_ccgs" problem.sat_num=34 scenario.constellations="ICEYE"
    sleep 3
  done
done
